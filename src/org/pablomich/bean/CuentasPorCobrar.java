...
public class CuentasPorCobrar {
    ...
    public String toString() {
        return "CuentasPorCobrar{" + "id=" + id + ", numeroFactura=" + numeroFactura + ", anio=" + anio + ", mes=" + mes + ", valorNetoPago=" + valorNetoPago + ", estadoPago=" + estadoPago + ", codigoAdministracion=" + codigoAdministracion + ", codigoCliente=" + codigoCliente + ", codigoLocal=" + codigoLocal + '}';
    }
